  ...
  <div class="wrap">
    <div class="content">
      <div class="fly-tab fly-tab-index">
        ...
        <a href="${pageContext.request.contextPath}/jie/addjsp" class="layui-btn jie-add">发布问题</a>
      </div>
      ...
      <ul class="fly-list">
      	<s:forEach items="${list }" var="list">
      		<li class="fly-list-li">
	          <a href="user/home.html" class="fly-list-avatar">
	            <img src="${pageContext.request.contextPath}/res/images/avatar/default.png" alt="">
	          </a>
	          <h2 class="fly-tip">
	            <a href="${pageContext.request.contextPath}/jie/detail/${list.id}">${list.title }</a>
	          </h2>
	          <p>
	            <span><a href="user/home.html">${list.nickname }</a></span>
	            <span>${string }</span>
	            <span>${list.name }</span>
	            <span class="fly-list-hint"> 
	              <i class="iconfont" title="回答">&#xe60c;</i> ${list.num}
	              <i class="iconfont" title="人气">&#xe60b;</i> ${list.view_count }
	            </span>
	          </p>
	        </li>
      	</s:forEach>
